...
export default function FaceScanPage() {
  ...
  useEffect(() => {
    ...
    const loadModels = async (): Promise<void> => {
      try {
        ...
        // Use the global model manager to load models with progress updates
  ...
  }, [modelsLoaded, faceapi, livenessDone, step, verifyFace, analyzeLighting, showScanAgain, addErrorMessage, resetCheck]);
